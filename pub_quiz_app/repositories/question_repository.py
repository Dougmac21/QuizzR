...
def save(question):
    ...
    values = [question.the_question, question.correct_answer, question.alt_ans_1, question.alt_ans_2, question.alt_ans_3, question.difficulty, question.topic]
...
def select(id):
    ...
    question = Question(result["the_question"], result["correct_answer"], result["alt_ans_1"], result["alt_ans_2"], result["alt_ans_3"], result["difficulty"], result["topic"], result["id"])
    return question
